        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/80 mb-6 text-base leading-relaxed">
              Your travel family since 2009. Come join thousands of friends making unforgettable memories together!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300 text-base">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+15017993820" className="text-primary-foreground font-medium hover:underline">
                    (501) 799-3820
                  </a>
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 text-base mb-4">
              Be the first to hear about new trips, waitlist openings, and fun updates from the iTravel family!
            </p>
